...
// Helpers
import { dataFake, labels } from "./TableLiveStream.helper";
...
// Styles
import Styles from "./TableLiveStream.styles";

const { palette } = variables;

export default function TableLiveStream(props) {
  const { liveStreamList } = props;
  const { isLoading, data } = liveStreamList;
                          ...
                          >
                            ...
                            <TableCell className="tableComponent__text tableComponent__text--secondary">
                              <Chip
                                ...
                                className="chip"
                                label={row?.state ? "Publicar" : "Deshabilitar"}
                              />
                            </TableCell>
                            <TableCell className="tableComponent__text tableComponent__text--secondary">
                              <Button className="tableComponent__button">
