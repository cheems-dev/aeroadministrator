...
// Helper
import { alumnoCourse, dataFake } from "./CoursesEndDetails.helper";
import { labels, temarioFake } from "./CoursesEndDetails.helper";
// Custom hooks
...
// Styles
import Styles from "./CoursesEndDetails.styles";

const { palette } = variables;

export default function CoursesEndDetails() {
  const { id } = useParams();
      ...
      {isLoading ? (
        ...
        <Styles>
          ...
          <div className="header">
            <p className="header__text">Cursos online culminados</p>
            <p
              ...
              {topic?.isLoading ? (
                ...
                <div className="wrapperData">
                  <ul className="wrapperData__line">
                    ...
                    <li>Cantidad de horas: {topic?.hours} horas</li>
                    <li>Duración días: {topic?.days} dias</li>
