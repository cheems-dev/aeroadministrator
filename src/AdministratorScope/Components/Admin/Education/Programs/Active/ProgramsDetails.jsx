...
// Helper
import { dataFake, temarioFake, userCourse } from "./ProgramsDetails.helper";
import { labels, labelsSelect } from "./ProgramsDetails.helper";
// Custom hooks
import useGeneralProgramsQuery from "../../../../../Utils/customHooks/useProgramsQuery";
// Styles
import Styles from "./ProgramsDetails.styles";
      ...
      {isLoading ? (
        ...
        <Styles>
          ...
          <div className="header">
            <p className="header__text">Programas online activos </p>
          ...
          <div className="containerData">
            <div className="containerData__box">
              <div className="containerData__wrapper">
                <h1 className="containerData__title">{program.name}</h1>
